...
#include "AzureStorageCpplite/blob/download_blob_request.h"
#include "AzureStorageCpplite/blob/create_block_blob_request.h"
#include "AzureStorageCpplite/blob/delete_blob_request.h"
#include "AzureStorageCpplite/blob/copy_blob_request.h"
#include "AzureStorageCpplite/blob/create_container_request.h"
#include "AzureStorageCpplite/blob/delete_container_request.h"
#include "AzureStorageCpplite/blob/list_containers_request.h"
#include "AzureStorageCpplite/blob/list_blobs_request.h"
#include "AzureStorageCpplite/blob/get_block_list_request.h"
#include "AzureStorageCpplite/blob/get_blob_property_request.h"
#include "AzureStorageCpplite/blob/get_container_property_request.h"
#include "AzureStorageCpplite/blob/put_block_request.h"
#include "AzureStorageCpplite/blob/put_block_list_request.h"
#include "AzureStorageCpplite/blob/append_block_request.h"
#include "AzureStorageCpplite/blob/put_page_request.h"
#include "AzureStorageCpplite/blob/get_page_ranges_request.h"

#include "AzureStorageCpplite/executor.h"
#include "AzureStorageCpplite/utility.h"
#include "AzureStorageCpplite/tinyxml2_parser.h"
#include <curl/curl.h>
